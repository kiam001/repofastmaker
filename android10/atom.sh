...
mkdir atom
cd atom
repo init -u https://github.com/ATOM-COMMUNITY-PROJECT/manifest -b ten --depth=1
git clone https://github.com/ATOM-COMMUNITY-PROJECT/cedric_official .repo/local_manifests
repo sync -c -j$(nproc --all) --force-sync --no-clone-bundle --no-tags
. build/envsetup.sh
lunch aosp_cedric-eng
